...
enum Erase_Ids {
 ...
 cxpr std::array<char const*, TEXT_COL_SIZE> TEXT_COLOR_CODES_N = {{
    "\033[39m", //default
 ...
 cxpr std::array<char const*, BG_COL_SIZE> BG_COLOR_CODES_N = {{
    "\033[40m", "\033[41m", "\033[42m", "\033[43m",
    "\033[44m", "\033[45m", "\033[46m", "\033[47m",
    "\033[100m", "\033[101m", "\033[102m", "\033[103m",
    "\033[104m", "\033[105m", "\033[106m", "\033[107m",
}};
 cxpr std::array<char const*, TEXT_STYLE_SIZE * 2> TEXT_STYLE_CODES_N = {{
...
// static cxpr array<const char*, CURSOR_IDS_SIZE> CURSOR_CODES_N{{
...
//    "\033[#H" //reset
//}};
// static cxpr array<const char*, ERASE_IDS_SIZE> ERASE_CODES_N{{
//    "\033[2K", //erase line
...
void col_stream::print(Text_Colors col, std::string_view str) const { *_oStream << dev::ansiCode(col) << str << dev::ansiCode(_current->textCol()); }

void col_stream::println(Text_Colors col, std::string_view str) const {
    print(col, str);
    *_oStream << '\n';
}
...
col_stream console{&std::cout};
col_stream error{&std::cerr, console.state()};
