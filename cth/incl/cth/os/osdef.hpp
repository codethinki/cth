#pragma once
#if defined(WIN32) && !defined(CTH_PLATFORM_WINDOWS)
...
#if defined(CTH_PLATFORM_WINDOWS) + defined(CTH_PLATFORM_LINUX) + defined(CTH_PLATFORM_ANDROID) != 1
...
#elif defined(CTH_PLATFORM_LINUX) || defined(CTH_PLATFORM_ANDROID)
#define CTH_FS_POSIX
#endif
