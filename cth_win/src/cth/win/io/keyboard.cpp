...
#pragma pop_macro("DELETE")
            ...
            case Key::ESCAPE: vk = VK_ESCAPE;
                break;
            case Key::HOME: vk = VK_HOME;
                flags |= KEYEVENTF_EXTENDEDKEY;
                break;
            case Key::INSERT: vk = VK_INSERT;
                flags |= KEYEVENTF_EXTENDEDKEY;
                break;
            case Key::PAGE_DOWN: vk = VK_NEXT;
                flags |= KEYEVENTF_EXTENDEDKEY;
                break;
            case Key::PAGE_UP: vk = VK_PRIOR;
                flags |= KEYEVENTF_EXTENDEDKEY;
                break;
            case Key::TAB: vk = VK_TAB;
                break;

            case Key::ARROW_DOWN: vk = VK_DOWN;
                flags |= KEYEVENTF_EXTENDEDKEY;
                break;
            case Key::ARROW_LEFT: vk = VK_LEFT;
                flags |= KEYEVENTF_EXTENDEDKEY;
                break;
            case Key::ARROW_RIGHT: vk = VK_RIGHT;
                flags |= KEYEVENTF_EXTENDEDKEY;
                break;
            case Key::ARROW_UP: vk = VK_UP;
                flags |= KEYEVENTF_EXTENDEDKEY;
                break;

            case Key::ALT: vk = right ? VK_RMENU : VK_LMENU;
                if(right) flags |= KEYEVENTF_EXTENDEDKEY;
                break;
            case Key::CONTROL: vk = right ? VK_RCONTROL : VK_LCONTROL;
                if(right) flags |= KEYEVENTF_EXTENDEDKEY;
                break;
            ...
            case Key::NUM_LOCK: vk = VK_NUMLOCK;
                flags |= KEYEVENTF_EXTENDEDKEY;
                break;
